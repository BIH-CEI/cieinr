...
[![Python CI](https://github.com/BIH-CEI/cieinr/github/workflows/python_ci.yml/badge.svg)](https://github.com/BIH-CEI/cieinr/.github/workflows/python_ci.yml)
...
1. Clone the repository with submodules:
   ```bash
   git clone https://github.com/BIH-CEI/cieinr.git
   cd cieinr
